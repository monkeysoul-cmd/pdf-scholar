...
$$;`;
  ...
  const resumePoints = [
    {
      title: "Full-Stack RAG Pipeline",
      desc: "Architected a full-stack Retrieval-Augmented Generation (RAG) educational suite utilizing Express and React, enabling instant processing of multi-page academic papers."
    },
    {
