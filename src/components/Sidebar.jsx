...
export default function Sidebar() {
  ...
  const SidebarInner = ({ collapsed }) => (
    <aside
      ...
      } bg-black/50 backdrop-blur-2xl text-white border-r border-white/5 flex flex-col h-full select-none relative shadow-2xl transition-all duration-300 ease-in-out shrink-0 z-50`}
