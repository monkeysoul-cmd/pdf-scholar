...
export default function Overview() {
  ...
  return (
    <div
      className="flex-1 pt-16 md:pt-8 px-4 sm:px-6 md:px-12 pb-8 md:pb-12 overflow-y-auto min-h-0 flex flex-col bg-[#080808] text-white select-none relative"
      id="overview-view"
    >
      {/* Upper Header */}
      <motion.div
      ...
      >
        <h1 className="text-3xl sm:text-4xl md:text-5xl font-black tracking-tight leading-none uppercase text-white">
          Study Hub <br />
          ...
          {primaryStats.map((stat) => {
            ...
            return (
              <motion.div
                ...
                className="bg-[#101010] p-4 sm:p-6 rounded-sm border border-zinc-800/80 flex flex-col justify-between shadow-xl relative overflow-hidden group transition-all min-h-[120px] sm:h-36 cursor-pointer"
              >
                ...
                <div>
                  <div className="text-2xl sm:text-3xl md:text-4xl font-black tracking-tight text-white leading-none">
                    {stat.value}
                  </div>
      ...
      <AnimatePresence>
        {activeModal && (
          <motion.div
            ...
            className="fixed inset-0 z-50 bg-black/80 backdrop-blur-md flex items-end sm:items-center justify-center p-0 sm:p-4 md:p-8"
          >
            <motion.div
              ...
              className="bg-[#101010] border border-zinc-800 rounded-t-lg sm:rounded-sm w-full max-w-3xl max-h-[90vh] sm:max-h-[85vh] overflow-y-auto shadow-2xl p-5 sm:p-6 md:p-8 relative text-white flex flex-col gap-6"
            >
              {/* Close Button */}
              <button
                onClick={() => setActiveModal(null)}
